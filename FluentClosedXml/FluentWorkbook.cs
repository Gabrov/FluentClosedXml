...
public class FluentWorkbook : IDisposable
{
    ...
    public static FluentWorkbook Create() => new();
    ...
    public static FluentWorkbook Load(string filePath) => new(filePath);
    ...
    /// <param name="stream">Stream containing Excel data</param>
    /// <returns>FluentWorkbook instance</returns>
    public static FluentWorkbook Load(Stream stream) => new(stream);
